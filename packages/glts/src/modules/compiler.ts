...
export function validateScript(source: string, context: CompilationContext): void {
...
export function compileScript(source: string, context: CompilationContext): string {
  try {
    validateScript(source, context);
  } catch (error) {
